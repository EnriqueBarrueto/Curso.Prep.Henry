...
function esEntero(numero) {
  ...
  // Tu código:
  if (Math.floor(numero)===numero) {return true;} else {return false;}
}
...
function fizzBuzz(numero) {
  ...
  else if (numero%3===0 && numero%5 !== 0) {return "fizz";}
...
let digitos  = text.length;
if (digitos === 3) {return true;} else {return false;}
}
